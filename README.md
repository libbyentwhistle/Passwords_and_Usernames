...
This project explores, using Python, password generation following standard rules for passwords given on websites namely: 
 - Between 8 and 17 characters long
...
This code ensures that there is at least one uppercase character, one lowercase character, one number and one special character. The password is then bulked out to be between 8 and 17 characters with any random combination of uppercase characters, lowercase characters, numbers and special characters. 
